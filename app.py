...
# ============================================
# 🔥 Paths (শক্তিশালী fallback + auto create)
# ============================================
def _find_writable_data_dir():
    """একাধিক জায়গা চেক করে যেটা writable সেটা return করে"""
    candidates = []
...
print("=" * 55)
print(f"📂 ALAMIN_BOSS_DIR = {ALAMIN_BOSS_DIR}")
print(f"📂 ALAMIN_BOSS_ZIP_DIR = {ALAMIN_BOSS_ZIP_DIR}")
...
def _abk_log(msg):
    try:
        os.makedirs(os.path.dirname(ALAMIN_BOSS_LOG), exist_ok=True)
...
def _abk_make_code(server_id, username=None):
    try:
        ...
        os.makedirs(os.path.dirname(ALAMIN_BOSS_CODES), exist_ok=True)
...
if __name__ == '__main__':
    ...
    print(f"📍 Uploads dir: {ALAMIN_BOSS_DIR}")
    print(f"📍 ZIP dir: {ALAMIN_BOSS_ZIP_DIR}")
